...
function App() {
  ...
  const onResultClick = () => {
    ...
    fetch("http://115.85.183.139:30002/upload", imgRequestOptions)
  ...
  const onFeedbackClick = () => {
    ...
    fetch("http://115.85.183.139:30002/notion", infoRequestOptions).then(
  ...
  return (
    <div className="page">
      ...
      {/* -----차량 이미지 업로드----- */}
      <div
        className="uploadCarImage"
        align="center"
        style={{ display: loadingUserinfo }}
      >
        <div style={{ float: "left", marginRight: "10px" }}>
          ...
          />
          <form>
            <label className="carImgLabel" htmlFor="carFront">
              {carFrontImg
                ? "차량 전면 이미지 추가 완료"
                : "차량 전면 이미지를 추가해주세요"}
            </label>
        ...
        <div style={{ float: "right" }}>
          ...
          />
          <form>
            <label className="carImgLabel" htmlFor="carBack">
              {carBackImg
                ? "차량 후면 이미지 추가 완료"
                : "차량 후면 이미지를 추가해주세요"}
            </label>
        ...
        <div style={{ float: "left", marginRight: "10px" }}>
          ...
          />
          <form>
            <label className="carImgLabel" htmlFor="carLeft">
              {carLeftImg
                ? "차량 좌측 이미지 추가 완료"
                : "차량 좌측 이미지를 추가해주세요"}
            </label>
        ...
        <div style={{ float: "right" }}>
          ...
          />
          <form>
            <label className="carImgLabel" htmlFor="carRight">
              {carRightImg
                ? "차량 우측 이미지 추가 완료"
                : "차량 우측 이미지를 추가해주세요"}
            </label>
        ...
        <div align="center">
          <button
            ...
            disabled={
              carFrontState && carBackState && carLeftState && carRightState
                ? false
                : true
            }
          >
      ...
      <div align="center" style={{ display: uploadingImg }}>
        <div style={{ float: "left", marginRight: "10px" }}>
          <img
            className="carImage"
            src={carFrontRes ? carFrontRes : carFrontPrev}
            alt="차량 전면 이미지 결과"
          ></img>
          <form>
            <label className="carImgLabel" htmlFor="carFrontRes">
              {"차량 전면 이미지 결과"}
            </label>
          </form>
        </div>
        <div style={{ float: "right" }}>
          <img
            className="carImage"
            src={carBackRes ? carBackRes : carBackPrev}
            alt="차량 후면 이미지 결과"
          ></img>
          <form>
            <label className="carImgLabel" htmlFor="carBackRes">
              {"차량 후면 이미지 결과"}
            </label>
          </form>
        </div>
        <div style={{ float: "left", marginRight: "10px" }}>
          <img
            className="carImage"
            src={carLeftRes ? carLeftRes : carLeftPrev}
            alt="차량 죄측 이미지 결과"
          ></img>
          <form>
            <label className="carImgLabel" htmlFor="carLeftRes">
              {"차량 좌측 이미지 결과"}
            </label>
          </form>
        </div>
        <div style={{ float: "right" }}>
          <img
            className="carImage"
            src={carRightRes ? carRightRes : carRightPrev}
            alt="차량 우측 이미지 결과"
          ></img>
          <form>
            <label className="carImgLabel" htmlFor="carRightRes">
              {"차량 우측 이미지 결과"}
            </label>
          </form>
        </div>
